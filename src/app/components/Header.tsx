...
const Header: React.FC = () => {
  ...
  return (
    <>
    <header className='fixed top-0 left-0 right-0 w-full pb-2  flex flex-row justify-center items-center border-b-2 border-white z-[90]' style={{ backgroundColor: (scrollY > 0 || isOpen) ? "#1D1D1D" : "transparent" }}>
